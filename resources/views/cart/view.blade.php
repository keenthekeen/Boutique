    ...
    @if ($order->status == 'unpaid')
        <div>
            ...
            <ul class="collapsible popout">
                ...
                <li>
                    <div class="collapsible-header" id="cc-header"><i class="material-icons">credit_card</i> บัตร VISA / MasterCard / JCB</div>
                    <div class="collapsible-body">
                        <form action="/cart/pay/card" method="post" id="cc-checkout">
                            ...
                            <div class="row">
                                <div class="input-field col s12 m6">
                                    <input type="text" data-omise="holder_name" id="cc-name" autocomplete="cc-name" required/>
                                    <label for="cc-name">ชื่อผู้ถือบัตร</label>
                                </div>
                                <div class="input-field col s12 m6">
                                    <input type="text" data-omise="number" id="cc-number" autocomplete="cc-number" required/>
                                    <label for="cc-number">เลขที่บัตร</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s3">
                                    <input type="number" id="cc-month" required step="1" min="1" max="12" data-omise="expiration_month" autocomplete="cc-exp-month"/>
                                    <label for="cc-month">เดือนหมดอายุ</label>
                                </div>
                                <div class="input-field col s3">
                                    <input type="number" id="cc-year" required step="1" min="2018" max="2030" data-omise="expiration_year" autocomplete="cc-exp-year"/>
                                    <label for="cc-year">ปีหมดอายุ</label>
                                </div>
                                <div class="input-field col s6">
                                    <input type="number" id="cc-cvv" required step="1" data-omise="security_code" autocomplete="cc-csc"/>
                                    <label for="cc-cvv">CVV</label>
                                </div>
                            </div>
                            <button class="btn orange waves-effect fullwidth" type="submit" id="create_token">ชำระด้วยบัตรเครดิต</button>
                        </form>
                    </div>
                </li>
            </ul>
